...
public class MazeBuilderEllerTest {
	...
	@Before
	public void setUp(){
		control = new MazeController(Order.Builder.Eller);
		control.init();
	...
	//Test to make sure that the build was a success with the proper skill level, etc...
	@Test
	...
	//Test to make sure that a solution exists from each cell in the maze by checking the distances of the cells around each individual cell.
	@Test
